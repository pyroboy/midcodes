		...
		<div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
			<div>
				...
				<p class="text-muted-foreground">
					...
					{:else}
						{formatMonth(reportData.reportPeriod.startMonth)} to {formatMonth(
							reportData.reportPeriod.endMonth
						)}
					{/if}
				</p>
			</div>
		...
		<div class="print-container">
			<Card.Root>
				<Card.Header>
					...
					<Card.Description>Active leases grouped by floor and rental unit</Card.Description>
				</Card.Header>
				<Card.Content>
