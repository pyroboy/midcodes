...
>
	<Card.Content
		class="py-6 px-6 border-t border-slate-200/40 hover:bg-slate-50/50 transition-colors duration-200"
	>
		<!-- Main Row -->
		<div class="flex flex-col lg:flex-row lg:items-center w-full gap-4 lg:gap-6">
				...
				<div class="flex items-center">
					<DropdownMenu.Root>
						<DropdownMenu.Trigger>
							<div
								class="flex items-center gap-2 px-3 py-1 rounded-md bg-slate-100 text-slate-700 text-sm cursor-pointer hover:bg-slate-200 transition-colors font-medium"
							>
			...
			<div class="w-full lg:w-1/3 flex items-center justify-center">
				<div class="text-center">
					{#if !lease.billings || lease.billings.length === 0}
						...
						<div class="text-lg italic text-slate-400 font-light">No Billings Yet</div>
					{:else}
						<!-- Balance Breakdown -->
							...
							<div class="text-2xl text-slate-600">
								{#if lease.balanceStatus.overdueBalance > 0}
									<span class="text-red-600"
										>₱{lease.balanceStatus.overdueBalance.toLocaleString()} overdue</span
									>
								{/if}
								{#if lease.balanceStatus.partialBalance > 0}
									...
									<span class="text-amber-600"
										>₱{lease.balanceStatus.partialBalance.toLocaleString()} partial</span
									>
								{/if}
								{#if lease.balanceStatus.pendingBalance > 0}
									{#if lease.balanceStatus.overdueBalance > 0 || lease.balanceStatus.partialBalance > 0}
										•
									{/if}
									<span class="text-orange-600"
										>₱{lease.balanceStatus.pendingBalance.toLocaleString()} pending</span
									>
								{/if}
			...
			<div
				class="flex items-center justify-center lg:justify-end gap-1 sm:gap-2 flex-wrap w-full lg:w-1/3"
			>
				<Tooltip.Provider>
					<Tooltip.Root>
						<Tooltip.Trigger>
							...
							>
								<CreditCard
									class="w-4 h-4 sm:w-5 sm:h-5 group-hover/payment:scale-110 transition-transform"
								/>
							</Button>
						</Tooltip.Trigger>
						<Tooltip.Content>
				...
				<Tooltip.Provider>
					<Tooltip.Root>
						<Tooltip.Trigger>
							...
							>
								<Pencil
									class="w-4 h-4 sm:w-5 sm:h-5 group-hover/edit:scale-110 transition-transform"
								/>
							</Button>
						</Tooltip.Trigger>
						<Tooltip.Content>
				...
				<Tooltip.Provider>
					<Tooltip.Root>
						<Tooltip.Trigger>
							...
							>
								<Home
									class="w-4 h-4 sm:w-5 sm:h-5 group-hover/rent:scale-110 transition-transform"
								/>
							</Button>
						</Tooltip.Trigger>
						<Tooltip.Content>
				...
				<Tooltip.Provider>
					<Tooltip.Root>
						<Tooltip.Trigger>
							...
							>
								<Shield
									class="w-4 h-4 sm:w-5 sm:h-5 group-hover/security:scale-110 transition-transform"
								/>
							</Button>
						</Tooltip.Trigger>
						<Tooltip.Content>
				...
				<Tooltip.Provider>
					<Tooltip.Root>
						<Tooltip.Trigger>
							...
							>
								<Printer
									class="w-4 h-4 sm:w-5 sm:h-5 group-hover/print:scale-110 transition-transform"
								/>
							</Button>
						</Tooltip.Trigger>
						<Tooltip.Content>
				...
				<Tooltip.Provider>
					<Tooltip.Root>
						<Tooltip.Trigger>
							...
							>
								<Trash2
									class="w-4 h-4 sm:w-5 sm:h-5 group-hover/delete:scale-110 transition-transform"
								/>
							</Button>
						</Tooltip.Trigger>
						<Tooltip.Content>
