...
<div class="container mx-auto p-4 flex flex-col lg:flex-row gap-4">
	<div class="w-full lg:w-2/3">
		...
		<Card>
			<CardContent class="p-0">
				<div
					class="hidden md:grid md:grid-cols-[1fr_1fr_1fr_auto] gap-4 px-4 py-2 font-medium border-b bg-muted/50"
				>
	...
	<div class="w-full lg:w-1/3">
		<Card>
			...
			<CardContent>
				<FloorForm {data} {editMode} form={formData} {errors} {enhance} {constraints} />
			</CardContent>
		</Card>
	</div>
</div>
