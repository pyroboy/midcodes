	...
	<Dialog.Portal>
		...
		>
			<Dialog.Header>
				...
				<Dialog.Description>Select the format and date range for the export.</Dialog.Description>
			</Dialog.Header>
			<div class="grid gap-4 py-4">
				...
				<div class="grid grid-cols-4 items-center gap-4">
					...
					<Input id="date-from" type="date" class="col-span-3" bind:value={fromDate} />
				</div>
				<div class="grid grid-cols-4 items-center gap-4">
					<Label for="date-to" class="text-right">To</Label>
					<Input id="date-to" type="date" class="col-span-3" bind:value={toDate} />
				</div>
			</div>
			<Dialog.Footer>
