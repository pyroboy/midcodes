...
<footer class="bg-white py-12 px-4">
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      <h3 class="text-lg font-semibold mb-4">Cabilao Cliffs Dive Resort</h3>
      <ul class="space-y-2">
        <li><a href="/" class="text-gray-600 hover:text-blue-600">The Resort</a></li>
        <li><a href="/experiences" class="text-gray-600 hover:text-blue-600">Experiences</a></li>
        <li><a href="/restaurant" class="text-gray-600 hover:text-blue-600">Restaurant</a></li>
        <li><a href="/gallery" class="text-gray-600 hover:text-blue-600">Gallery</a></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex gap-4">
          ...
          <a 
            href="https://instagram.com/hresort" 
  ...
  <div class="max-w-7xl mx-auto mt-8 pt-8 border-t border-gray-200">
    <p class="text-center text-gray-500">
      Copyright © {currentYear} ElPower Travel and Tours — Cabilao Cliffs Dive Resorts. All rights reserved.
    </p>
    <p class="text-center text-sm text-gray-400 mt-2">
      Developed by Arjo Magno
    </p>
  </div>
</footer>