...
export const actions = {
    updateQuantity: async ({ request, cookies }: import('./$types').RequestEvent) => {
    ...
    removeItem: async ({ request, cookies }: import('./$types').RequestEvent) => {
        const data = await request.formData();
        const productId = data.get('productId');
    ...
    checkout: async ({ cookies }: import('./$types').RequestEvent) => {
