import { c as create_ssr_component, b as each, e as escape, s as subscribe, v as validate_component } from "../../chunks/ssr.js";
import { s as session } from "../../chunks/auth.js";
import "../../chunks/index2.js";
import "../../chunks/client.js";
import { p as page } from "../../chunks/stores.js";
import { B as Button } from "../../chunks/button.js";
const DokmutyaLanding = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let stats = [
    {
      number: "20+",
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  $$unsubscribe_session();
  return `${$$result.head += `<!-- HEAD_svelte-1yy93p7_START -->${$page.data.shouldShowDokmutya ? `${$$result.title = `<title>DokMutya - Healthcare Leadership for Bohol</title>`, ""} <meta name="description" content="Building a Healthier First District - Dr. Maria Santos for Board Member"> <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&amp;display=swap" rel="stylesheet">` : `${$$result.title = `<title>ID Card Generator - Professional ID Cards in Minutes</title>`, ""} <meta name="description" content="Design, generate, and manage ID cards for your organization. Easy to use, professional results.">`}<!-- HEAD_svelte-1yy93p7_END -->`, ""} ${$page.data.shouldShowDokmutya ? `${validate_component(DokmutyaLanding, "DokmutyaLanding").$$render($$result, {}, {}, {})}` : `<div class="container py-8 md:py-12"><div class="mx-auto flex max-w-[980px] flex-col items-center gap-8"><div class="flex flex-col items-center space-y-4 text-center"><h1 class="text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:text-5xl lg:leading-[1.1]">${$session ? `Welcome to ID Card Generator` : `Create Professional ID Cards in Minutes`}</h1> <p class="max-w-[750px] text-lg text-muted-foreground sm:text-xl">${$session ? `Start creating professional ID cards or manage your existing ones.` : `Design, generate, and manage ID cards for your organization. Easy to use, professional results.`}</p></div> <div class="flex gap-4">${$session ? `${validate_component(Button, "Button").$$render($$result, { size: "lg" }, {}, {
    default: () => {
      return `Create New ID`;
    }
  })} ${validate_component(Button, "Button").$$render($$result, { size: "lg", variant: "outline" }, {}, {
    default: () => {
      return `View My IDs`;
    }
