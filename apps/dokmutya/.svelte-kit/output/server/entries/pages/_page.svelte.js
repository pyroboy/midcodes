...
function _page($$payload) {
  let stats = [
    { number: "20+", label: "Years in Healthcare" },
    { number: "12", label: "Municipalities Served" },
    { number: "300K+", label: "Citizens Reached" }
  ];
  let priorities = [
    {
