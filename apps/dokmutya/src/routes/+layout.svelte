...
<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 {hasScrolled ? 'bg-white/90 backdrop-blur-sm shadow-sm' : 'bg-gradient-to-b from-[#32949199] to-transparent'}"> 
