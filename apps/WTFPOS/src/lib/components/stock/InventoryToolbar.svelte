...
<div class="mb-4 flex flex-col md:flex-row md:items-center gap-3">
	...
	<div class="flex items-center gap-2">
		<button onclick={onExpandAll} class="text-xs font-semibold px-3 py-2 bg-gray-50 border border-border text-gray-600 rounded-lg hover:bg-gray-100 transition-colors">
			Expand All
		</button>
		<button onclick={onCollapseAll} class="text-xs font-semibold px-3 py-2 bg-gray-50 border border-border text-gray-600 rounded-lg hover:bg-gray-100 transition-colors">
			Collapse All
		</button>
	</div>
