...
<div
	class="absolute right-2 top-2 flex gap-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xs rounded-md p-1"
>
	<Button
		variant="ghost"
...
<div class="mobile-spacing">
	...
	<Button class="mobile-button w-full">Create Template</Button>
</div>
```
...
<nav class="flex mobile-spacing">
	<Button href="/templates" variant="ghost" class="mobile-button justify-start">
		<FileText class="h-5 w-5 mr-2" />
		Templates
	</Button>

	<Button href="/all-ids" variant="ghost" class="mobile-button justify-start">
