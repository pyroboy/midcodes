...
<div class="h-[calc(100vh-4rem)] overflow-hidden flex flex-col">
	<div class="flex-1 container mx-auto px-4 py-8 relative w-full h-full flex flex-col lg:flex-row gap-8 items-center lg:justify-center overflow-y-auto lg:overflow-visible">
		...
		<div class="hidden lg:flex w-full lg:w-2/3 h-[50vh] lg:h-full items-center justify-center relative">
			<div class="absolute inset-0 flex items-center justify-center opacity-30">
				<div class="relative w-[300px] h-[450px] rounded-[15px] border-4 border-dashed border-primary/50 animate-pulse flex items-center justify-center">
