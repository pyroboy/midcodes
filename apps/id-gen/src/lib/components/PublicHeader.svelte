		...
		<div class="flex w-full items-center justify-between py-4">
			...
			<div class="flex items-center">
				<a href="/" class="flex items-center space-x-2">
					<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-r from-blue-600 to-purple-600">
			...
			<div class="md:hidden border-t border-gray-200 bg-white py-4">
				<div class="space-y-3">
					...
					<div class="border-t border-gray-200 pt-3 mt-3 px-4 space-y-2">
						<Button variant="ghost" class="w-full justify-start" href="/auth">
							Sign In
						</Button>
						<Button class="w-full" href="/auth?mode=signup">
							Start Free Trial
						</Button>
					</div>
				</div>
