        ...
        <div class="space-y-4">
            ...
            <div class="space-y-3">
                {#each croppingInfo() as imageInfo}
                    <div class="border rounded-lg p-3 {imageInfo.willBeCropped ? 'border-orange-200 bg-orange-50' : 'border-green-200 bg-green-50'}">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    {#if imageInfo.willBeCropped}
                                        ...
                                        <span class="text-xs bg-orange-200 text-orange-800 px-2 py-1 rounded">Will be cropped</span>
                                    {:else}
                                        <span class="font-medium text-green-800">{imageInfo.side} Background</span>
                                        <span class="text-xs bg-green-200 text-green-800 px-2 py-1 rounded">No cropping needed</span>
                                    {/if}
                                </div>
