<script lang="ts">
    ...
    let finalCardSize = $derived(() => {
        const baseSize = selectedSizeType === 'common' ? selectedCommonSize : 
        ...
        <div class="space-y-6">
                ...
                {#if selectedSizeType === 'common'}
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {#each COMMON_CARD_SIZES as size}
                            ...
                            <Card 
                                class="cursor-pointer transition-colors {selectedCommonSize === size ? 'border-primary bg-primary/5' : 'hover:border-primary/50'}"
                                ...
                                <CardContent class="p-3">
                                    ...
                                    <div class="flex justify-center mb-2">
                                        <div 
                                            ...
                                            style="width: {Math.min(60, 60 * aspectRatio)}px; height: {Math.min(60 / aspectRatio, 60)}px;"
                                        ></div>
                                    </div>
                            ...
                            {#snippet customPreview()}
                                ...
                                <div class="flex justify-center">
                                    <div 
                                        ...
                                        style="width: {Math.min(80, 80 * aspectRatio)}px; height: {Math.min(80 / aspectRatio, 80)}px;"
                                    ></div>
                                </div>
            ...
            <div class="bg-primary/5 border border-primary/20 p-4 rounded-lg">
                    ...
                    {#snippet summaryPreview()}
                        ...
                        <div class="flex justify-center">
                            <div 
                                ...
                                style="width: {Math.min(40, 40 * aspectRatio)}px; height: {Math.min(40 / aspectRatio, 40)}px;"
                            ></div>
                        </div>
                    {/snippet}
                ...
                <div class="text-sm space-y-1">
                    ...
                    <div><strong>Size:</strong> {formatDimensions(finalCardSize(), false)} 
                        {isPortrait ? '(Portrait)' : '(Landscape)'}
                    </div>
                    <div><strong>Image:</strong> {pixelDimensions.width} × {pixelDimensions.height} pixels @ {DEFAULT_DPI} DPI</div>
                </div>
            </div>
