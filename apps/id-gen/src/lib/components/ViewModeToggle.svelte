...
<div class="inline-flex items-center gap-1 rounded-md border border-gray-200 dark:border-gray-700 p-1 bg-white dark:bg-gray-900" role="group" aria-label="View mode toggle">
	<button
	...
	>
		...
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-4 w-4">
			<path fill="currentColor" d="M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm2 0v4h14V5zm0 6v8h4v-8zm6 0v8h8v-8z" />
		</svg>
	</button>
	<button
...
<style>
	...
	:global(.dark) button { color: rgb(229 231 235); }
</style>
