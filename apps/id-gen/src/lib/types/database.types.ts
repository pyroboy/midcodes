	...
	public: {
		...
		Functions: {
			...
			confirm_attendee_payment: {
				Args: { p_attendee_id: string } | { p_attendee_id: string; p_received_by: string };
				Returns: Json;
			};
			create_payment: {
				Args: {
		...
		Enums: {
			...
			lease_status: 'ACTIVE' | 'INACTIVE' | 'EXPIRED' | 'TERMINATED' | 'PENDING' | 'ARCHIVED';
			...
			payment_frequency: 'MONTHLY' | 'QUARTERLY' | 'ANNUAL' | 'CUSTOM' | 'ONE_TIME';
