<script lang="ts">
    ...
    const paymentsEnabled = $derived((data?.paymentsEnabled ?? true) && $paymentFlags.paymentsEnabled);
...
<svelte:head>
    ...
    <meta name="description" content="Choose the perfect plan for your ID card generation needs. Affordable credit packages and premium features." />
</svelte:head>
...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600 dark:text-gray-300 mb-6 max-w-3xl mx-auto">
            Choose from flexible credit packages or unlock premium features. 
            Perfect for individuals, small businesses, and large organizations.
        </p>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-orange-700 dark:text-orange-300 mt-1">
                                Payments are disabled for your organization. Please contact an administrator for manual credit provisioning. Prices shown are for reference only.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!-- Free Tier Info -->
        <Card class="max-w-md mx-auto bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-800">
    ...
    <div class="mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {#each CREDIT_PACKAGES as pkg}
                <Card class="relative transition-all duration-200 hover:shadow-xl {pkg.popular ? 'ring-2 ring-primary scale-105' : ''}">
                    {#if pkg.popular}
    ...
    <div class="text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto text-left">
            ...
            <Card>
                ...
                <CardContent>
                    <p class="text-gray-600 dark:text-gray-300">
                        We accept major credit/debit cards, GCash, PayMaya, GrabPay, and online banking 
                        through our secure PayMongo integration.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent>
                    <p class="text-gray-600 dark:text-gray-300">
                        Yes! Our larger credit packages offer significant savings. For enterprise needs 
                        (1000+ cards), contact us for custom pricing.
                    </p>
                </CardContent>
            </Card>
        </div>
