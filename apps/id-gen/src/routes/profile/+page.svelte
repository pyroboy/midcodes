						...
						<div class="space-y-6">
							...
							<div class="flex items-center justify-between">
								...
								<Switch 
									...
									onCheckedChange={(checked) => { preferences.darkMode = checked; }}
								/>
							</div>
							...
							<div class="space-y-4">
								<div class="flex items-center justify-between">
									...
									<Switch 
										...
										onCheckedChange={(checked) => { preferences.emailNotifications = checked; }}
									/>
								</div>
								...
								<div class="flex items-center justify-between">
									...
									<Switch 
										...
										onCheckedChange={(checked) => { preferences.adminNotifications = checked; }}
			...
			<Card>
				...
				<CardContent class="space-y-3">
					<Button href="/auth/reset-password" variant="outline" class="w-full justify-start">
						<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-6 6c-3 0-5.197-1.756-6.586-4M7 7a2 2 0 012-2m0 0c0-3-1-5-3-5s-3 2-3 5m3-5v4m-3-1h6m-2-3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>
