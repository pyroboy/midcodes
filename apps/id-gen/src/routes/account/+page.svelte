...
<svelte:head>
    ...
    <meta name="description" content="Manage your account, view credits balance, and track your transaction history." />
</svelte:head>
            ...
            <CardContent class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-900 dark:text-blue-100">{data.userCredits?.credits_balance || 0}</p>
                    </div>
            ...
            <CardContent class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-900 dark:text-green-100">{data.userCredits?.card_generation_count || 0}</p>
                    </div>
                ...
                <p class="text-sm text-green-700 dark:text-green-300 mt-2">
                    {(data.userCredits?.card_generation_count || 0) < 10 ? 
                        `${10 - (data.userCredits?.card_generation_count || 0)} free left` : 
                        'Using paid credits'}
                </p>
            </CardContent>
        </Card>
            ...
            <CardContent class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-900 dark:text-purple-100">{data.userCredits?.template_count || 0}</p>
                    </div>
                ...
                <p class="text-sm text-purple-700 dark:text-purple-300 mt-2">
                    {data.userCredits?.unlimited_templates ? 
                        'Unlimited templates' : 
                        `${Math.max(0, 2 - (data.userCredits?.template_count || 0))} free left`}
                </p>
            </CardContent>
        </Card>
    </div>
        ...
        <Card>
            ...
            <CardContent class="space-y-4">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div>
                        {#if data.userCredits?.unlimited_templates}
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div>
                        {#if data.userCredits?.remove_watermarks}
                            <Badge class="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300">Active</Badge>
                        {:else if !$paymentFlags.paymentsEnabled}
                            <div class="text-xs text-gray-500 dark:text-gray-400 text-center max-w-32">
                                Purchases temporarily disabled. Contact admin for manual provisioning.
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            {#each data.creditHistory as transaction}
