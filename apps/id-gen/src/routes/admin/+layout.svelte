<script lang="ts">
	...
	$effect(() => {
		...
		const hasAdminRole = data.user.role && ['super_admin', 'org_admin', 'id_gen_admin'].includes(data.user.role);
		if (!hasAdminRole) {
		...
		<div class="container mx-auto px-4">
			<div class="flex justify-between items-center h-16">
				...
				<div class="flex items-center space-x-4">
					...
					<a href="/profile" class="px-3 py-2 rounded hover:bg-gray-700 text-sm">
						Profile
					</a>
				</div>
			</div>
