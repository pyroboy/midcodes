...
const securityHeadersHandle: Handle = async ({ event, resolve }) => {
	...
	const connectSrc = dev
		? "connect-src 'self' blob: https://api.runware.ai https://*.runware.ai https://*.neon.tech https://assets.kanaya.app https://cdn.jsdelivr.net http://localhost:* ws://localhost:* https://cloudflareinsights.com https://static.cloudflareinsights.com https://*.supabase.co"
		: "connect-src 'self' https://api.runware.ai https://*.runware.ai https://*.neon.tech https://assets.kanaya.app https://cdn.jsdelivr.net http://localhost:* ws://localhost:* https://cloudflareinsights.com https://static.cloudflareinsights.com https://*.supabase.co";

	const cspDirectives = [
		"default-src 'self'",
		"script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdn.jsdelivr.net https://static.cloudflareinsights.com",
		"style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
		"img-src 'self' data: blob: https://*.neon.tech https://assets.kanaya.app https://*.fal.media https://im.runware.ai https://*.supabase.co", // Custom R2 domain, fal.ai images, and legacy Supabase assets
