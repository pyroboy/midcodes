...
// Credit transaction schema (credit_transactions table)
export const creditTransactionSchema = z.object({
	id: z.string().uuid().optional(),
	user_id: z.string().uuid(),
	org_id: z.string().uuid(),
	transaction_type: z.enum(['purchase', 'usage', 'refund', 'bonus', 'adjustment']),
	amount: z.number().int(), // Positive for credits, negative for usage
