<script lang="ts">
	...
	let thumbnailUrlValue = $state(form?.thumbnailUrl ?? '');
</script>

<svelte:head>
	<title>New Sermon - MOFI Admin</title>
</svelte:head>

<div class="flex items-center justify-between mb-6">
	<h1 class="text-2xl font-bold text-gray-900">New Sermon</h1>
	<a
		href="/admin/sermons"
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
	<form method="POST" class="space-y-5" onsubmit={() => { submitting = true; }}>
		...
		<div class="flex items-center gap-3 pt-4">
			...
			>
				{submitting ? 'Saving...' : 'Create Sermon'}
			</button>
