...
<form method="POST" class="space-y-0" onsubmit={() => { submitting = true; }}>
	...
	<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
		<div class="space-y-5">
			...
			<div class="flex items-center gap-2 mt-2">
				<input id="isActive" name="isActive" type="checkbox" checked class="rounded border-gray-300 text-red-600 focus:ring-red-500" />
				<label for="isActive" class="text-sm font-medium text-gray-700">Active</label>
			</div>

			<!-- Pastor Assignment -->
			<h2 class="text-lg font-semibold text-gray-900 mt-6 mb-4 pt-6 border-t border-gray-100">Pastor Assignment</h2>

			<div class="space-y-1.5">
				<label for="pastorId" class="block text-sm font-medium text-gray-700">Assign Pastor (optional)</label>
				<select
					id="pastorId"
					name="pastorId"
					class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm"
	...
	<div class="flex items-center gap-3 pt-4 mt-6">
		...
		>
			{submitting ? 'Saving...' : 'Create Church'}
		</button>
