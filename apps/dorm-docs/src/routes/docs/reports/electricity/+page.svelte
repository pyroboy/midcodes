<script lang="ts">
	import type { ElectricityReportData } from '$lib/types/reports';
	import electricityData from '$lib/data/electricity.json';

	const data = electricityData as ElectricityReportData;
</script>

<svelte:head>
	<title>Electricity Report - DA Tirol Dorm</title>
</svelte:head>
	...
	<section class="summary-section">
		...
		<div class="summary-grid">
			<div class="summary-card">
				...
				<span class="value">{data.summary.total_consumption_kwh.toLocaleString()} kWh</span>
			</div>
			<div class="summary-card">
			...
			<div class="summary-card">
				...
				<span class="value">₱{data.summary.average_rate}/kWh</span>
			</div>
			<div class="summary-card">
			...
			<table>
				...
				<tfoot>
					<tr>
						...
						<td><strong>{data.summary.total_consumption_kwh} kWh</strong></td>
						<td></td>
