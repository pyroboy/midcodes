...
function validateTemplateCreation(data: any) {
	/* logic */
}
function validateTemplateUpdate(data: any) {
	/* similar logic */
}
function validateTemplateDeletion(data: any) {
	/* similar logic */
}
...
function performOperation(entity: string, action: string, id: string) {
	/* unclear */
}
