...
**Kanaya** (formerly id-gen) is a comprehensive ID card generation application built with SvelteKit 2.x. It enables users to create, customize, and generate ID cards using templates, AI-powered asset decomposition, 3D previews, and fast QR-based encoding.
