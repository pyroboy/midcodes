...
<div class="bp-layout">
	...
	<nav class="chapter-nav">
		{#if prev}
			<a href="/admin/docs/business-plan/{prev.slug}" class="nav-item prev">
		...
		<div class="nav-center">
			<a href="/admin/docs" class="home-link">❖ DOCS HUB</a>
		</div>

		{#if next}
			<a href="/admin/docs/business-plan/{next.slug}" class="nav-item next">
