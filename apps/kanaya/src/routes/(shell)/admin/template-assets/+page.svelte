				...
				<div class="rounded-lg bg-muted/50 p-4">
					...
					<dl class="grid grid-cols-2 gap-4 text-sm">
						...
						<div>
							...
							<dd class="font-medium text-foreground">
								{$assetUploadStore.detectedRegionsFront.length +
									$assetUploadStore.detectedRegionsBack.length}
							</dd>
						</div>
						<div>
						...
						<div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
							{#each $previewPairs as pair, index (pair.id)}
								<div class="relative overflow-hidden rounded-lg border border-border bg-muted">
									<div
										class="aspect-[1.6/1] flex items-center justify-center text-muted-foreground"
									>
					...
					<div class="flex gap-3">
						...
						<div>
							...
							<p class="mt-1 text-sm text-blue-600/80 dark:text-blue-400/80">
								Your template assets have been uploaded and saved. You can now manage them in the
								assets dashboard.
							</p>
						</div>
					</div>
