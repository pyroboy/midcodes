						...
						<div class="space-y-6">
							...
							<div class="space-y-4">
								<div class="flex items-center justify-between">
									...
									<input type="hidden" name="emailNotifications" value={preferences.emailNotifications !== false ? 'on' : 'off'} />
									<Switch
								...
								<div class="flex items-center justify-between">
									...
									<input type="hidden" name="adminNotifications" value={preferences.adminNotifications !== false ? 'on' : 'off'} />
									<Switch
		...
		<div class="space-y-6">
			...
			<Card>
				...
				<CardContent class="space-y-3">
					...
					{:else}
						<div class="space-y-3 p-4 border border-destructive/50 rounded-lg bg-destructive/5">
							<p class="text-sm font-medium text-destructive">This action is permanent and cannot be undone.</p>
							<form
								method="POST"
							...
							>
								<div class="space-y-3">
									<div class="space-y-1">
										<Label for="deletePassword" class="text-sm">Enter your password</Label>
										<Input
											id="deletePassword"
											name="password"
											type="password"
									...
									<div class="space-y-1">
										<Label for="deleteConfirm" class="text-sm">Type DELETE to confirm</Label>
										<Input
											id="deleteConfirm"
											name="confirmation"
