<script lang="ts">
	...
	async function updateOrgName() {
		...
		errorMessage = 'Organization name update is not yet available. Contact your administrator.';
		isEditingName = false;
	}

	async function updateMemberRole(memberId: string, newRole: string) {
		errorMessage = 'Member role management is not yet available. Contact your administrator.';
	}
	...
	async function removeMember(memberId: string, email: string | null) {
		...
		errorMessage = 'Member removal is not yet available. Contact your administrator.';
	}
