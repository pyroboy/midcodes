...
export const templateSampleTypeEnum = pgEnum('template_sample_type', [
	'student',
	'employee',
	'membership',
	'visitor',
...
export const pipelineTargetTypeEnum = pgEnum('pipeline_target_type', [
	'school',
	'company',
	'government'
]);

export const pipelineTargets = pgTable('pipeline_targets', {
	id: uuid('id').primaryKey().defaultRandom(),
	name: text('name').notNull(),
	org: text('org').notNull(),
	type: pipelineTargetTypeEnum('type').notNull(),
