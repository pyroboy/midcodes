...
export const RECIPES = [
  {
    ...
    ingredients:[
      { label:"Pork Scraps",  qty:80,  unit:"g",  source:"meat_scrap" },
      { label:"Kimchi",       qty:100, unit:"g",  source:"side" },
      { label:"Tofu",         qty:0.5, unit:"pc", source:"pantry" },
      { label:"Gochugaru",    qty:10,  unit:"g",  source:"pantry" },
      { label:"Garlic",       qty:10,  unit:"g",  source:"pantry" },
      { label:"Soy Sauce",    qty:15,  unit:"ml", source:"pantry" },
  ...
  },
  {
    ...
    ingredients:[
      { label:"Pork Scraps",  qty:60,  unit:"g",  source:"meat_scrap" },
      { label:"Soft Tofu",    qty:1,   unit:"pc", source:"pantry" },
      { label:"Egg",          qty:1,   unit:"pc", source:"pantry" },
      { label:"Gochugaru",    qty:8,   unit:"g",  source:"pantry" },
      { label:"Garlic",       qty:8,   unit:"g",  source:"pantry" },
      { label:"Sesame Oil",   qty:5,   unit:"ml", source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Steamed Rice", qty:200, unit:"g",  source:"pantry" },
      { label:"Beef Scraps",  qty:60,  unit:"g",  source:"meat_scrap" },
      { label:"Egg",          qty:1,   unit:"pc", source:"pantry" },
      { label:"Gochujang",    qty:20,  unit:"g",  source:"pantry" },
      { label:"Sesame Oil",   qty:5,   unit:"ml", source:"pantry" },
      { label:"Garlic",       qty:5,   unit:"g",  source:"pantry" },
      { label:"Vegetables",   qty:80,  unit:"g",  source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Steamed Rice", qty:220, unit:"g",  source:"pantry" },
      { label:"Beef Scraps",  qty:70,  unit:"g",  source:"meat_scrap" },
      { label:"Egg",          qty:1,   unit:"pc", source:"pantry" },
      { label:"Gochujang",    qty:25,  unit:"g",  source:"pantry" },
      { label:"Sesame Oil",   qty:8,   unit:"ml", source:"pantry" },
      { label:"Cooking Oil",  qty:5,   unit:"ml", source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Steamed Rice", qty:250, unit:"g",  source:"pantry" },
      { label:"Pork Scraps",  qty:60,  unit:"g",  source:"meat_scrap" },
      { label:"Egg",          qty:1,   unit:"pc", source:"pantry" },
      { label:"Garlic",       qty:10,  unit:"g",  source:"pantry" },
      { label:"Onion",        qty:30,  unit:"g",  source:"pantry" },
      { label:"Soy Sauce",    qty:15,  unit:"ml", source:"pantry" },
      { label:"Cooking Oil",  qty:10,  unit:"ml", source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Tteok",       qty:200, unit:"g",  source:"pantry" },
      { label:"Gochujang",   qty:30,  unit:"g",  source:"pantry" },
      { label:"Sugar",       qty:10,  unit:"g",  source:"pantry" },
      { label:"Soy Sauce",   qty:10,  unit:"ml", source:"pantry" },
      { label:"Garlic",      qty:5,   unit:"g",  source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Steamed Rice", qty:200, unit:"g",  source:"pantry" },
      { label:"Seaweed",      qty:2,   unit:"sheet",source:"pantry" },
      { label:"Egg",          qty:1,   unit:"pc", source:"pantry" },
      { label:"Vegetables",   qty:60,  unit:"g",  source:"pantry" },
      { label:"Sesame Oil",   qty:5,   unit:"ml", source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Pork Scraps",  qty:100, unit:"g",  source:"meat_scrap" },
      { label:"Flour",        qty:80,  unit:"g",  source:"pantry" },
      { label:"Garlic",       qty:8,   unit:"g",  source:"pantry" },
      { label:"Onion",        qty:40,  unit:"g",  source:"pantry" },
      { label:"Soy Sauce",    qty:10,  unit:"ml", source:"pantry" },
      { label:"Cooking Oil",  qty:15,  unit:"ml", source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Flour",        qty:100, unit:"g",  source:"pantry" },
      { label:"Eggs",         qty:2,   unit:"pc", source:"pantry" },
      { label:"Green Onion",  qty:50,  unit:"g",  source:"pantry" },
      { label:"Cooking Oil",  qty:20,  unit:"ml", source:"pantry" },
      { label:"Soy Sauce",    qty:10,  unit:"ml", source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Glass Noodles",qty:100, unit:"g",  source:"pantry" },
      { label:"Beef Scraps",  qty:50,  unit:"g",  source:"meat_scrap" },
      { label:"Vegetables",   qty:80,  unit:"g",  source:"pantry" },
      { label:"Sesame Oil",   qty:10,  unit:"ml", source:"pantry" },
      { label:"Soy Sauce",    qty:15,  unit:"ml", source:"pantry" },
      { label:"Sugar",        qty:5,   unit:"g",  source:"pantry" },
    ],
  ...
  },
  {
    ...
    ingredients:[
      { label:"Ramyun Pack",  qty:1,   unit:"pack",source:"pantry" },
      { label:"Egg",          qty:1,   unit:"pc", source:"pantry" },
      { label:"Green Onion",  qty:10,  unit:"g",  source:"pantry" },
    ],
